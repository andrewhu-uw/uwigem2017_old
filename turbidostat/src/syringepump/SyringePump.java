...
public class SyringePump {
	...
	public SyringePump(GpioPinDigitalOutput motorPin, String motorName, 
		...
		//this.motor = gpio.provisionDigitalOutputPin(motorPin, motorName);
		//this.direction = gpio.provisionDigitalOutputPin(directionMotor, directionMotorName);
...
/*
	...
	public void setGoal(int newGoal) {
		/*if(newGoal < FLUID_EMPTY || newGoal > ) {
